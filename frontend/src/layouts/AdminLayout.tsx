...
export default function AdminLayout() {
  ...
  const { adminLogout, adminUser } = useStore();
  ...
  return (
    <div className="min-h-screen bg-[#0B0B0D] flex">
      ...
      {/* Sidebar */}
      <aside
        className={`fixed lg:static inset-y-0 left-0 z-50 w-64 bg-[#111113] border-r border-white/10 transform transition-transform duration-300 lg:transform-none ${sidebarOpen ? 'translate-x-0' : '-translate-x-full'
          }`}
      >
        <div className="flex flex-col h-full">
          ...
          <div className="p-4 border-t border-white/10">
            <div className="flex items-center gap-3 px-4 py-3 mb-2">
              ...
              <div>
                <p className="text-white font-medium text-sm">{adminUser?.firstName} {adminUser?.lastName}</p>
